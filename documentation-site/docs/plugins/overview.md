...
The CHANGELOG mentions **The Movie Database (TMDB)**, **TVDB**, **YouTube**, and **MusicBrainz**. They live in the [obscura-community-plugins](https://github.com/pauljoda/obscura-community-plugins) sister repo, not in the main repo. They're the easiest reference reads for "what does a real plugin look like."
