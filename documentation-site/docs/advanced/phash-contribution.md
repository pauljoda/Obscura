...
description: How Obscura generates Stash-compatible perceptual hashes and submits them back to the community index.
---
...
2. The auto-submit job runs: every fingerprint Obscura has for that video (MD5, OSHASH, PHASH) is submitted to the StashBox endpoint.
