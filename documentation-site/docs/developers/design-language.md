...
description: Dark Room visual direction for Obscura.
---

# Design Language

Obscura follows the Dark Room direction: a sharp, cinematic interface for managing a private media library.
