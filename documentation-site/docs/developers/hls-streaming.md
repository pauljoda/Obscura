...
Obscura serves video playback through the .NET backend. The Svelte player
...
- Playback negotiation lives in `apps/backend/src/Obscura.Infrastructure/Videos`.
- Public playback routes live in `apps/backend/src/Obscura.Api/Endpoints`.
