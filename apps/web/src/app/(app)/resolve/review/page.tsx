            ...
            <div key={result.id} className="surface-panel p-5 space-y-4">
              ...
              <div className="surface-well p-3 space-y-0">
                {result.proposedTitle && (
                  <ReviewField label="Title" value={result.proposedTitle} />
                )}
                {result.proposedDate && (
                  <>
                ...
                {result.proposedPerformerNames &&
                  result.proposedPerformerNames.length > 0 && (
                    <>
                      <div className="separator" />
                      <ReviewField
                        label="Performers"
                        value={result.proposedPerformerNames.join(", ")}
                      />
                    </>
                  )}
                {result.proposedTagNames && result.proposedTagNames.length > 0 && (
                  <>
                    ...
                    <ReviewField
                      label="Tags"
                      value={result.proposedTagNames.join(", ")}
                    />
                  </>
                )}
                {result.proposedUrl && (
