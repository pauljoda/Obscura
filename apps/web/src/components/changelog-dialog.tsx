  ...
  return (
    <>
      ...
      <dialog
        ...
        className="fixed inset-0 m-auto flex h-[85vh] w-[90vw] max-w-3xl flex-col border border-border-subtle bg-surface-1 p-0 text-text-primary backdrop:bg-black/70 open:flex sm:h-[80vh]"
      >
