...
describe("fetchVideos", () => {
  ...
  it("includes the full video filter set in the request query", async () => {
    const fetchApiMock = vi.mocked(core.fetchApi);
    ...
    const path = fetchApiMock.mock.calls[0]?.[0] as string;
