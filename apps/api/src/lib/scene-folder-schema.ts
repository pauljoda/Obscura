...
export const SCENE_FOLDER_SCHEMA_MISSING_MESSAGE =
  "Scene folders require a database migration. Run pnpm --filter @obscura/api db:migrate.";
...
export async function requireSceneFolderSchema() {
