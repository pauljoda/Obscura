  ...
  const sceneData = [
    {
      ...
      details: "A cinematic shoot captured during the golden hour along the Pacific coastline. Features stunning natural lighting and aerial drone transitions.",
      date: "2024-11-15",
      rating: 90,
      filePath: "/media/scenes/golden_hour_coast.mp4",
    ...
    },
    {
      ...
      details: "Raw behind-the-scenes footage from the Neon series production. Unscripted moments between takes with the full cast.",
      date: "2024-10-20",
      rating: 78,
      filePath: "/media/scenes/bts_neon.mp4",
      fileSize: 2.8 * 1024 * 1024 * 1024,
      duration: 1930,
      width: 1920,
      height: 1080,
      frameRate: 29.97,
    ...
    {
      title: "Glass Ceiling",
      details: "Documentary-style interview intercut with performance footage. Explores the intersection of art and intimacy in modern media production.",
      date: "2024-07-12",
      rating: 82,
      filePath: "/media/scenes/glass_ceiling.mp4",
      fileSize: 5.3 * 1024 * 1024 * 1024,
      duration: 1720,
      width: 3840,
      height: 2160,
      frameRate: 23.976,
