<script lang="ts" generics="F extends string">
  ...
  import type { FilterPreset } from "./PresetDropdownV1.svelte";
  import type { AlphabeticalFilterSectionItem } from "./AlphabeticalFilterSectionV1.svelte";
  import SearchBox from "./SearchBoxV1.svelte";
  import SortControl from "./SortControlV1.svelte";
  import ViewModeToggle from "./ViewModeToggleV1.svelte";
  import ActiveFilterChips from "./ActiveFilterChipsV1.svelte";
  import ThumbSizeSlider from "./ThumbSizeSliderV1.svelte";
  import PresetDropdown from "./PresetDropdownV1.svelte";
  import FilterDrawer, { type FilterSectionKey } from "./FilterDrawerV1.svelte";
