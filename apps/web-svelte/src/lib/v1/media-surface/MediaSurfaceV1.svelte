<script lang="ts" generics="T extends { id: string }, F extends string">
  ...
  import { createPaginatedCollection } from "./pagination/paginated-collection-v1.svelte";
  import InfiniteLoadTrigger from "./pagination/InfiniteLoadTriggerV1.svelte";
  import Toolbar from "./toolbar/ToolbarV1.svelte";
  import {
    createSurfacePrefs,
    type SurfacePrefsFormFactor,
    surfacePresetsKey,
  } from "./prefs/surface-prefs-v1.svelte";
  import { encodeSurfacePrefs } from "./prefs/prefs-codec-v1";
  ...
  import ThumbnailGrid from "./body/ThumbnailGridV1.svelte";
  import ListBody from "./body/ListBodyV1.svelte";
  import FeedBody from "./body/FeedBodyV1.svelte";
  import MasonryBody from "./body/MasonryBodyV1.svelte";
  import EmptyState from "./body/EmptyStateV1.svelte";
