<script lang="ts">
  ...
  import type { VideoField, VideoRow } from "$lib/v1/identify/scrape-types-v1";
  import { VIDEO_FIELDS } from "$lib/v1/identify/scrape-types-v1";
  import ReviewDrawer from "./ReviewDrawerV1.svelte";
  import VideoReviewDrawer from "../scrape/VideoReviewDrawerV1.svelte";
