<script lang="ts">
  ...
  import type { BookField, BookRow } from "$lib/v1/identify/identify-types-v1";
  import BookRowCard from "./BookRowCardV1.svelte";
  import BookReviewDrawer from "./BookReviewDrawerV1.svelte";
