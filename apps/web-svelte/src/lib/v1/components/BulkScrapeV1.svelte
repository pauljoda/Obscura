<script lang="ts">
  ...
  import type {
    ...
    TagItem,
    Tab,
  } from "$lib/v1/identify/scrape-types-v1";
  import {
    VIDEO_FIELDS,
    tabEntityLabel,
  ...
  import { runPerformerScrape, acceptAllPerformers } from "$lib/v1/identify/scrape-performers-runner-v1";
  import { runStudioScrape, acceptAllStudios } from "$lib/v1/identify/scrape-studios-runner-v1";
  import { runTagScrape, acceptAllTags } from "$lib/v1/identify/scrape-tags-runner-v1";
  import {
    runVideoSeriesIdentify,
    seekSeriesSingle,
    acceptAllVideoSeries,
  } from "$lib/v1/identify/identify-video-series-runner-v1";
  import {
    runBookIdentify,
    seekBookSingle,
    seekBookSingleByURL,
    acceptAllBooks,
  } from "$lib/v1/identify/book-runner-v1";
  import {
    runAudioLibraryIdentify,
    seekAudioLibrarySingle,
    acceptAllAudioLibraries,
  } from "$lib/v1/identify/audio-library-runner-v1";
  import {
    runAudioTrackIdentify,
    seekAudioTrackSingle,
    acceptAllAudioTracks,
  } from "$lib/v1/identify/audio-track-runner-v1";
  import {
    runGalleryIdentify,
    seekGallerySingle,
    seekGallerySingleByURL,
    acceptAllGalleries,
  } from "$lib/v1/identify/gallery-runner-v1";
  import {
    runImageIdentify,
    seekImageSingle,
    acceptAllImages,
  } from "$lib/v1/identify/image-runner-v1";
  import type { MutableFlag } from "$lib/v1/identify/runner-utils-v1";
  import { filterIdentifyQueueItems } from "$lib/v1/identify/identify-queue-v1";
  ...
  import VideosTab from "./scrape/VideosTabV1.svelte";
  import PerformersTab from "./scrape/PerformersTabV1.svelte";
  import StudiosTab from "./scrape/StudiosTabV1.svelte";
  import TagsTab from "./scrape/TagsTabV1.svelte";
  import PhashesTab from "./scrape/PhashesTabV1.svelte";
  import VideoSeriesTab from "./identify/VideoSeriesTabV1.svelte";
  import BooksTab from "./identify/BooksTabV1.svelte";
  import GalleriesTab from "./identify/GalleriesTabV1.svelte";
  import ImagesTab from "./identify/ImagesTabV1.svelte";
  import AudioLibrariesTab from "./identify/AudioLibrariesTabV1.svelte";
  import AudioTracksTab from "./identify/AudioTracksTabV1.svelte";
