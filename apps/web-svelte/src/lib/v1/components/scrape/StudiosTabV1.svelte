<script lang="ts">
  import type { StudioRow } from "$lib/v1/identify/scrape-types-v1";
  import {
    acceptStudioRow,
    rejectStudioRow,
  } from "$lib/v1/identify/scrape-studios-runner-v1";
  import StudioRowCard from "./StudioRowCardV1.svelte";
