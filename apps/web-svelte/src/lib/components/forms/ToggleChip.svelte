<script lang="ts">
  ...
  const onClasses = $derived(
    variant === "warning"
      ...
      : "border border-border-accent bg-accent-950 text-accent-300 shadow-[0_0_12px_rgba(199,155,92,0.22)]",
  );
</script>
...
<button
  ...
  class={cn(
    "inline-flex items-center gap-2 px-3 py-2 text-[0.78rem] transition-all duration-fast",
