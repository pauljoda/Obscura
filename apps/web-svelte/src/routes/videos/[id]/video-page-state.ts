import type { V2LibrarySettings } from "$lib/api/v2";
import type {
  SubtitleAppearance,
  SubtitleDisplayStyle,
} from "$lib/player/subtitle-types";

const transcriptDockedKey = "obscura:transcript-docked";
const transcriptDockWidthKey = "obscura:transcript-dock-width";
...
export function buildSubtitleDefaults(
  settings: V2LibrarySettings | null,
