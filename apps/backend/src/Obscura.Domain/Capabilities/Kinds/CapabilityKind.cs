...
/// <summary>
/// Base implementation for code-defined capability kinds.
/// </summary>
/// <typeparam name="TCapability">Concrete capability value represented by this kind.</typeparam>
public abstract class CapabilityKind<TCapability> : ICapabilityKind<TCapability>
    where TCapability : class, ICapability
{
    ...
    protected CapabilityKind(string code, string displayName)
    {
        Code = code;
