...
/// Owns the backing list so concrete capabilities can expose domain-meaningful mutation
/// (add, remove, replace, reorder) instead of being replaced wholesale.
/// </summary>
...
public abstract class CollectionCapability<TItem> : EntityCapability {
    ...
    protected void SortBy<TKey>(Func<TItem, TKey> keySelector) {
