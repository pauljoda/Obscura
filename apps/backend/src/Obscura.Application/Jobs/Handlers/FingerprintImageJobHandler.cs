...
/// </summary>
public sealed class FingerprintImageJobHandler(
    ILogger<FingerprintImageJobHandler> logger,
    ...
    ILibraryScanPersistence persistence) : IJobHandler
{
    ...
    public async Task HandleAsync(JobContext context, CancellationToken cancellationToken)
    {
        ...
        {
            logger.LogWarning("FingerprintImage: source file not found for {EntityId}", entityId);
            return;
        }
        ...
        logger.LogInformation("FingerprintImage: {Label} — md5={Md5}", context.Job.TargetLabel, hashes.Md5[..8]);
