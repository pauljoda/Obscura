...
public interface ISettingsService
{
    ...
    /// <returns>Application settings result.</returns>
    Task<SettingsResult> GetAsync(CancellationToken cancellationToken);

    /// <summary>
    /// Applies a partial settings update.
    /// </summary>
    /// <param name="request">Settings update command from the API boundary.</param>
    /// <param name="cancellationToken">Token used to cancel the operation.</param>
    /// <returns>Application settings result after the update is saved.</returns>
    Task<SettingsResult> UpdateAsync(SettingsUpdate request, CancellationToken cancellationToken);
    ...
    Task<LibraryConfigResult> GetLibraryConfigAsync(CancellationToken cancellationToken);
    ...
    Task<LibrarySettingsResult> UpdateLibrarySettingsAsync(
    ...
    Task<LibraryBrowseResult> BrowseLibraryPathAsync(string? path, CancellationToken cancellationToken);
    ...
    Task<LibraryRootResult> CreateLibraryRootAsync(
    ...
    Task<LibraryRootResult?> UpdateLibraryRootAsync(
        Guid id,
